document.addEventListener("DOMContentLoaded", function(event) {
    ...
    if (app.stage){
        window.alert("PIXI DISPLAY HERE");
    }
    else{
        window.alert("PIXI DISPLAY NOT HERE");
    }


    var background = new PIXI.extras.TilingSprite(
        PIXI.Texture.fromImage('images/p2.jpeg'),
        WIDTH,
        HEIGHT);
    ...
    var bunnyTexture = PIXI.Texture.fromImage("images/cake1.png");
